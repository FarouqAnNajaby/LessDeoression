...
public class ResponseModelDataGejala {

    String nama_gejala, depresi_ringan, depresi_sedang, depresi_berat;
    double bobot_gejala;

    private List<DataModelGejala> data;
    ...
    public List<DataModelGejala> getData() {
        return data;
    }

    public void setData(List<DataModelGejala> data) {
        this.data = data;
    }
}
